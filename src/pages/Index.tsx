  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-purple-900 via-blue-900 to-indigo-900">
        ...
        <div className="relative max-w-6xl mx-auto px-6 py-20">
          <div className="text-center space-y-8">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
              <Link to="/generate">
                <Button size="lg" className="bg-gradient-to-r from-pink-500 to-purple-500 hover:from-pink-600 hover:to-purple-600 text-white text-lg px-8 py-6 transition-all duration-300 hover:scale-105 shadow-2xl border-0">
              ...
              <Link to="/dashboard">
                <Button size="lg" variant="outline" className="border-purple-400 text-purple-400 hover:text-white transition-all duration-300 bg-purple-600/20 hover:bg-purple-500/30 backdrop-blur-sm text-lg px-8 py-6">
      ...
      <section className="max-w-4xl mx-auto px-6 py-16 text-center">
        <Card className="bg-gradient-to-r from-purple-600/20 to-pink-600/20 backdrop-blur-lg border-white/20">
          <CardContent className="py-12">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <Link to="/generate">
                <Button size="lg" className="bg-gradient-to-r from-pink-500 to-purple-500 hover:from-pink-600 hover:to-purple-600 text-white text-lg px-8 py-6 transition-all duration-300 hover:scale-105 shadow-xl border-0">
                  <Zap className="w-5 h-5 mr-2" />
                  Generate Content Now
                </Button>
              </Link>
              <Link to="/settings">
                <Button size="lg" variant="outline" className="border-white/30 text-white hover:bg-white/10 transition-all duration-300 text-lg px-8 py-6">
