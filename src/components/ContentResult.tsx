...
Generated by ViralSlide
    ...
    return (
      <Button
        ...
        className={`transition-all duration-200 ${className} ${
          isCopied ? 'bg-green-500/20 border-green-400/50 text-green-300' : ''
        }`}
      >
        {isCopied ? (
          <>
  ...
  return (
    <div className="space-y-6">
          ...
          <div className="flex items-start justify-between">
            <div className="flex-1">
              ...
              <div className="flex flex-wrap gap-2 mb-3">
                ...
                <Badge variant="secondary" className="bg-green-500/20 text-green-300 flex items-center">
      ...
      {/* Hook Section */}
      <Card className="bg-white/10 backdrop-blur-lg border-white/20 border-pink-400/50">
        <CardHeader>
          <div className="flex items-center justify-between">
            <div className="flex-1">
              <CardTitle className="text-white flex items-center">
                🔥 Viral Hook (Slide 1)
                <span className="ml-2 text-sm font-normal text-pink-300">
            ...
            <CopyButton
              ...
              label="Hook"
              className="border-pink-400/20 text-pink-300 hover:bg-pink-400/10"
            />
          </div>
        </CardHeader>
        <CardContent>
      ...
      <Card className="bg-white/10 backdrop-blur-lg border-white/20">
        <CardHeader>
          <div className="flex items-center justify-between">
            <div className="flex-1">
              <CardTitle className="text-white">Content Slides (2-{content.slides.length + 1})</CardTitle>
                ...
                <div className="flex items-start justify-between">
                  <div className="flex-1">
                    <div className="flex items-center space-x-2 mb-2">
                      <span className="text-purple-400 font-medium text-sm">Slide {index + 2}</span>
                    ...
                    <p className="text-white leading-relaxed">{slide}</p>
                  </div>
                  <CopyButton
      ...
      {/* CTA Section */}
      <Card className="bg-white/10 backdrop-blur-lg border-white/20 border-green-400/50">
        <CardHeader>
          <div className="flex items-center justify-between">
            <div className="flex-1">
              <CardTitle className="text-white flex items-center">
                💡 Call-to-Action (Final Slide)
                <span className="ml-2 text-sm font-normal text-green-300">
          ...
          <div className="grid grid-cols-2 sm:grid-cols-3 gap-2">
            {content.searchTerms.map((term, index) => (
              <Button
                ...
                className="bg-purple-500/20 text-purple-300 hover:bg-purple-500/30 transition-colors justify-start text-left h-auto py-2 px-3"
              >
