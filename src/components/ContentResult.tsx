      ...
      <div className="backdrop-blur-xl bg-white/5 border border-white/10 rounded-2xl p-6 shadow-2xl hover:shadow-3xl transition-all duration-300">
        <div className="flex items-start justify-between">
          <div className="flex-1">
            ...
            <div className="bg-gradient-to-r from-blue-500/10 to-purple-500/10 rounded-xl p-4 border border-blue-400/30 backdrop-blur-sm mb-4">
              <h4 className="text-blue-200 font-bold text-sm mb-3 flex items-center">
                🤖 AI Content Analysis
              </h4>
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                <div className="text-center">
                  <div className={`text-2xl font-bold ${engagementPrediction.color} mb-1`}>
                    {engagementPrediction.score}%
                  </div>
                  <div className="text-xs text-white/70">Engagement Prediction</div>
                  <div className={`text-xs ${engagementPrediction.color} font-medium`}>
                    {engagementPrediction.level}
                  </div>
                </div>
                <div className="text-center">
                  <div className={`text-2xl font-bold ${hookStrength.score >= 7 ? 'text-green-400' : hookStrength.score >= 4 ? 'text-yellow-400' : 'text-red-400'} mb-1`}>
                    {hookStrength.score}/10
                  </div>
                  <div className="text-xs text-white/70">Hook Strength</div>
                  <div className={`text-xs ${hookStrength.score >= 7 ? 'text-green-400' : hookStrength.score >= 4 ? 'text-yellow-400' : 'text-red-400'} font-medium`}>
                ...
                <div className="text-center">
                  ...
                  <div className="text-xs text-white/70">Hook Variations</div>
      ...
      <div className="backdrop-blur-xl bg-white/5 border border-white/10 rounded-2xl p-6 shadow-2xl hover:shadow-3xl transition-all duration-300">
        <div className="mb-4">
          ...
          <p className="text-white/70 text-sm font-medium">
            Copy in different formats for various platforms
          </p>
        </div>
        <div className="grid grid-cols-2 md:grid-cols-4 gap-3 mb-4">
          <CopyButton
            ...
            label="Hook Only"
            className="border-blue-400/40 text-blue-200 hover:bg-blue-400/20 bg-blue-500/10 rounded-xl hover:scale-105"
          />
          <CopyButton
            onClick={copySlidesOnly}
            label="Slides Only"
            className="border-purple-400/40 text-purple-200 hover:bg-purple-400/20 bg-purple-500/10 rounded-xl hover:scale-105"
          />
          <CopyButton
            onClick={copyInstagramFormat}
            label="Instagram"
            className="border-pink-400/40 text-pink-200 hover:bg-pink-400/20 bg-pink-500/10 rounded-xl hover:scale-105"
          />
          <CopyButton
            onClick={copyTwitterThreadFormat}
            label="Twitter Thread"
            className="border-cyan-400/40 text-cyan-200 hover:bg-cyan-400/20 bg-cyan-500/10 rounded-xl hover:scale-105"
          />
        </div>
        <div className="flex justify-center">
          <CopyButton
            ...
            className="border-green-400/40 text-green-200 hover:bg-green-400/20 bg-green-500/10 px-6 rounded-xl hover:scale-105"
          />
        </div>
      </div>
