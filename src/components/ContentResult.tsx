  ...
  return (
    <div className="space-y-6">
        ...
        <div className="flex items-start justify-between">
          <div className="flex-1">
            ...
            <div className="flex flex-wrap gap-2 mb-4">
              ...
              <span className={`border border-opacity-30 px-3 py-1 rounded-full text-sm backdrop-blur-sm flex items-center ${engagementPrediction.color} bg-opacity-30`} style={{backgroundColor: engagementPrediction.color.replace('text-', '').replace('-400', '') + '20'}}>
                📊 {engagementPrediction.score}% engagement
              </span>
              <span className="bg-pink-500/20 text-pink-200 border border-pink-400/30 px-3 py-1 rounded-full text-sm backdrop-blur-sm flex items-center">
                🎯 Hook: {hookStrength.score}/10
              </span>
            </div>
      ...
      <div className="backdrop-blur-xl bg-white/5 border border-pink-400/20 rounded-2xl p-6 shadow-2xl hover:shadow-3xl transition-all duration-300">
        ...
        {content.hookVariations.length > 1 && (
          <div className="mb-6">
            <div className="text-sm text-pink-200 mb-3 font-medium">Choose your favorite hook:</div>
