      ...
      <div className="backdrop-blur-xl bg-gradient-to-r from-green-500/10 to-blue-500/10 border border-green-400/30 rounded-2xl p-6 shadow-2xl hover:shadow-3xl transition-all duration-300">
        ...
        <div className="grid grid-cols-2 md:grid-cols-5 gap-3">
          <CopyButton
            ...
            label="Hook Only"
            className="border-blue-400/40 text-blue-200 hover:bg-blue-400/20 bg-blue-500/10 rounded-xl hover:scale-105 font-medium"
          />
          <CopyButton
            onClick={copySlidesOnly}
            label="Slides Only"
            className="border-purple-400/40 text-purple-200 hover:bg-purple-400/20 bg-purple-500/10 rounded-xl hover:scale-105 font-medium"
          />
          <CopyButton
            onClick={copyInstagramFormat}
            label="Instagram"
            className="border-pink-400/40 text-pink-200 hover:bg-pink-400/20 bg-pink-500/10 rounded-xl hover:scale-105 font-medium"
          />
          <CopyButton
            onClick={copyTwitterThreadFormat}
            label="Twitter Thread"
            className="border-cyan-400/40 text-cyan-200 hover:bg-cyan-400/20 bg-cyan-500/10 rounded-xl hover:scale-105 font-medium"
          />
          <CopyButton
            onClick={copyAllSlides}
            label="Copy All"
            className="border-green-400/40 text-green-200 hover:bg-green-400/20 bg-green-500/10 rounded-xl hover:scale-105 font-medium"
          />
        </div>
      </div>
